...
var file_validator_proto_rawDesc = []byte{
	...
	0x18, 0x01, 0x20, 0x03, 0x28, 0x09, 0x52, 0x07, 0x73, 0x79, 0x6d, 0x62, 0x6f, 0x6c, 0x73, 0x32,
	0xed, 0x0b, 0x0a, 0x10, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x6f, 0x72, 0x53, 0x65, 0x72,
...
var file_validator_proto_msgTypes = make([]protoimpl.MessageInfo, 19)
var file_validator_proto_goTypes = []interface{}{
	...
	(*RestrictedSymbols)(nil),       // 16: zera_validator.RestrictedSymbols
	nil,                             // 17: zera_validator.Vote.VoteEntry
	nil,                             // 18: zera_validator.Proposal.OptionsEntry
	(*Validator)(nil),               // 19: zera_txn.Validator
	(*timestamppb.Timestamp)(nil),   // 20: google.protobuf.Timestamp
	(*TXNS)(nil),                    // 21: zera_txn.TXNS
	(*ItemContractFees)(nil),        // 22: zera_txn.ItemContractFees
	(*BaseTXN)(nil),                 // 23: zera_txn.BaseTXN
	(*ValidatorRegistration)(nil),   // 24: zera_txn.ValidatorRegistration
	(*CoinTXN)(nil),                 // 25: zera_txn.CoinTXN
	(*MintTXN)(nil),                 // 26: zera_txn.MintTXN
	(*ItemizedMintTXN)(nil),         // 27: zera_txn.ItemizedMintTXN
	(*InstrumentContract)(nil),      // 28: zera_txn.InstrumentContract
	(*GovernanceProposal)(nil),      // 29: zera_txn.GovernanceProposal
	(*GovernanceVote)(nil),          // 30: zera_txn.GovernanceVote
	(*SmartContractTXN)(nil),        // 31: zera_txn.SmartContractTXN
	(*SmartContractExecuteTXN)(nil), // 32: zera_txn.SmartContractExecuteTXN
	(*SelfCurrencyEquiv)(nil),       // 33: zera_txn.SelfCurrencyEquiv
	(*AuthorizedCurrencyEquiv)(nil), // 34: zera_txn.AuthorizedCurrencyEquiv
	(*ExpenseRatioTXN)(nil),         // 35: zera_txn.ExpenseRatioTXN
	(*NFTTXN)(nil),                  // 36: zera_txn.NFTTXN
	(*ContractUpdateTXN)(nil),       // 37: zera_txn.ContractUpdateTXN
	(*ValidatorHeartbeat)(nil),      // 38: zera_txn.ValidatorHeartbeat
	(*FoundationTXN)(nil),           // 39: zera_txn.FoundationTXN
	(*emptypb.Empty)(nil),           // 40: google.protobuf.Empty
}
var file_validator_proto_depIdxs = []int32{
	19, // 0: zera_validator.ValidatorSync.validators:type_name -> zera_txn.Validator
	20, // 1: zera_validator.BlockHeader.timestamp:type_name -> google.protobuf.Timestamp
	4,  // 2: zera_validator.Block.block_header:type_name -> zera_validator.BlockHeader
	21, // 3: zera_validator.Block.transactions:type_name -> zera_txn.TXNS
	5,  // 4: zera_validator.BlockBatch.blocks:type_name -> zera_validator.Block
	22, // 5: zera_validator.NFT.contract_fees:type_name -> zera_txn.ItemContractFees
	17, // 6: zera_validator.Vote.vote:type_name -> zera_validator.Vote.VoteEntry
	18, // 7: zera_validator.Proposal.options:type_name -> zera_validator.Proposal.OptionsEntry
	23, // 8: zera_validator.ProposalWalletRecieve.base:type_name -> zera_txn.BaseTXN
	23, // 9: zera_validator.ProposalWalletSend.base:type_name -> zera_txn.BaseTXN
	...
	24, // 13: zera_validator.ValidatorService.ValidatorRegistration:input_type -> zera_txn.ValidatorRegistration
	1,  // 14: zera_validator.ValidatorService.SyncValidatorList:input_type -> zera_validator.ValidatorSyncRequest
	25, // 15: zera_validator.ValidatorService.ValidatorCoin:input_type -> zera_txn.CoinTXN
	26, // 16: zera_validator.ValidatorService.ValidatorMint:input_type -> zera_txn.MintTXN
	27, // 17: zera_validator.ValidatorService.ValidatorItemMint:input_type -> zera_txn.ItemizedMintTXN
	28, // 18: zera_validator.ValidatorService.ValidatorContract:input_type -> zera_txn.InstrumentContract
	29, // 19: zera_validator.ValidatorService.ValidatorGovernProposal:input_type -> zera_txn.GovernanceProposal
	30, // 20: zera_validator.ValidatorService.ValidatorGovernVote:input_type -> zera_txn.GovernanceVote
	31, // 21: zera_validator.ValidatorService.ValidatorSmartContract:input_type -> zera_txn.SmartContractTXN
	32, // 22: zera_validator.ValidatorService.ValidatorSmartContractExecute:input_type -> zera_txn.SmartContractExecuteTXN
	33, // 23: zera_validator.ValidatorService.ValidatorCurrencyEquiv:input_type -> zera_txn.SelfCurrencyEquiv
	34, // 24: zera_validator.ValidatorService.ValidatorAuthCurrencyEquiv:input_type -> zera_txn.AuthorizedCurrencyEquiv
	35, // 25: zera_validator.ValidatorService.ValidatorExpenseRatio:input_type -> zera_txn.ExpenseRatioTXN
	36, // 26: zera_validator.ValidatorService.ValidatorNFT:input_type -> zera_txn.NFTTXN
	37, // 27: zera_validator.ValidatorService.ValidatorContractUpdate:input_type -> zera_txn.ContractUpdateTXN
	38, // 28: zera_validator.ValidatorService.ValidatorHeartbeat:input_type -> zera_txn.ValidatorHeartbeat
	39, // 29: zera_validator.ValidatorService.ValidatorFoundation:input_type -> zera_txn.FoundationTXN
	40, // 30: zera_validator.ValidatorService.StreamBroadcast:output_type -> google.protobuf.Empty
	40, // 31: zera_validator.ValidatorService.Broadcast:output_type -> google.protobuf.Empty
	0,  // 32: zera_validator.ValidatorService.SyncBlockchain:output_type -> zera_validator.DataChunk
	40, // 33: zera_validator.ValidatorService.ValidatorRegistration:output_type -> google.protobuf.Empty
	2,  // 34: zera_validator.ValidatorService.SyncValidatorList:output_type -> zera_validator.ValidatorSync
	40, // 35: zera_validator.ValidatorService.ValidatorCoin:output_type -> google.protobuf.Empty
	40, // 36: zera_validator.ValidatorService.ValidatorMint:output_type -> google.protobuf.Empty
	40, // 37: zera_validator.ValidatorService.ValidatorItemMint:output_type -> google.protobuf.Empty
	40, // 38: zera_validator.ValidatorService.ValidatorContract:output_type -> google.protobuf.Empty
	40, // 39: zera_validator.ValidatorService.ValidatorGovernProposal:output_type -> google.protobuf.Empty
	40, // 40: zera_validator.ValidatorService.ValidatorGovernVote:output_type -> google.protobuf.Empty
	40, // 41: zera_validator.ValidatorService.ValidatorSmartContract:output_type -> google.protobuf.Empty
	40, // 42: zera_validator.ValidatorService.ValidatorSmartContractExecute:output_type -> google.protobuf.Empty
	40, // 43: zera_validator.ValidatorService.ValidatorCurrencyEquiv:output_type -> google.protobuf.Empty
	40, // 44: zera_validator.ValidatorService.ValidatorAuthCurrencyEquiv:output_type -> google.protobuf.Empty
	40, // 45: zera_validator.ValidatorService.ValidatorExpenseRatio:output_type -> google.protobuf.Empty
	40, // 46: zera_validator.ValidatorService.ValidatorNFT:output_type -> google.protobuf.Empty
	40, // 47: zera_validator.ValidatorService.ValidatorContractUpdate:output_type -> google.protobuf.Empty
	40, // 48: zera_validator.ValidatorService.ValidatorHeartbeat:output_type -> google.protobuf.Empty
	40, // 49: zera_validator.ValidatorService.ValidatorFoundation:output_type -> google.protobuf.Empty
