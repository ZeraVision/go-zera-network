...
type Proposal struct {
	...
	Yes        string            `protobuf:"bytes,4,opt,name=yes,proto3" json:"yes,omitempty"`
	No         string            `protobuf:"bytes,5,opt,name=no,proto3" json:"no,omitempty"`
	Options    map[uint32]string `protobuf:"bytes,6,rep,name=options,proto3" json:"options,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
...
func (x *Proposal) GetOptions() map[uint32]string {
	if x != nil {
		return x.Options
	}
	return nil
...
var file_validator_proto_rawDesc = []byte{
	...
	0x3a, 0x02, 0x38, 0x01, 0x22, 0xa1, 0x02, 0x0a, 0x08, 0x50, 0x72, 0x6f, 0x70, 0x6f, 0x73, 0x61,
	...
	0x49, 0x64, 0x12, 0x10, 0x0a, 0x03, 0x79, 0x65, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x03, 0x79, 0x65, 0x73, 0x12, 0x0e, 0x0a, 0x02, 0x6e, 0x6f, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09,
	...
	0x20, 0x01, 0x28, 0x0c, 0x52, 0x06, 0x77, 0x61, 0x6c, 0x6c, 0x65, 0x74, 0x1a, 0x3a, 0x0a, 0x0c,
	...
	0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x96, 0x01, 0x0a, 0x15, 0x50, 0x72, 0x6f,
	...
	0x75, 0x6e, 0x74, 0x73, 0x22, 0x40, 0x0a, 0x0c, 0x43, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x63, 0x79,
	...
	0x52, 0x04, 0x72, 0x61, 0x74, 0x65, 0x22, 0x38, 0x0a, 0x0e, 0x45, 0x78, 0x70, 0x65, 0x6e, 0x73,
	...
	0x32, 0xa5, 0x0b, 0x0a, 0x10, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x6f, 0x72, 0x53, 0x65,
...
var file_validator_proto_msgTypes = make([]protoimpl.MessageInfo, 18)
var file_validator_proto_goTypes = []interface{}{
	...
	(*ProposalWalletRecieve)(nil),   // 12: zera_validator.ProposalWalletRecieve
	(*ProposalWalletSend)(nil),      // 13: zera_validator.ProposalWalletSend
	(*CurrencyRate)(nil),            // 14: zera_validator.CurrencyRate
	(*ExpenseTracker)(nil),          // 15: zera_validator.ExpenseTracker
	nil,                             // 16: zera_validator.Vote.VoteEntry
	nil,                             // 17: zera_validator.Proposal.OptionsEntry
	(*Validator)(nil),               // 18: zera_txn.Validator
	(*timestamppb.Timestamp)(nil),   // 19: google.protobuf.Timestamp
	(*TXNS)(nil),                    // 20: zera_txn.TXNS
	(*ItemContractFees)(nil),        // 21: zera_txn.ItemContractFees
	(*BaseTXN)(nil),                 // 22: zera_txn.BaseTXN
	(*ValidatorRegistration)(nil),   // 23: zera_txn.ValidatorRegistration
	(*CoinTXN)(nil),                 // 24: zera_txn.CoinTXN
	(*MintTXN)(nil),                 // 25: zera_txn.MintTXN
	...
	(*ExpenseRatioTXN)(nil),         // 34: zera_txn.ExpenseRatioTXN
	(*NFTTXN)(nil),                  // 35: zera_txn.NFTTXN
	(*ContractUpdateTXN)(nil),       // 36: zera_txn.ContractUpdateTXN
	(*ValidatorHeartbeat)(nil),      // 37: zera_txn.ValidatorHeartbeat
	(*emptypb.Empty)(nil),           // 38: google.protobuf.Empty
}
var file_validator_proto_depIdxs = []int32{
	18, // 0: zera_validator.ValidatorSync.validators:type_name -> zera_txn.Validator
	19, // 1: zera_validator.BlockHeader.timestamp:type_name -> google.protobuf.Timestamp
	4,  // 2: zera_validator.Block.block_header:type_name -> zera_validator.BlockHeader
	20, // 3: zera_validator.Block.transactions:type_name -> zera_txn.TXNS
	5,  // 4: zera_validator.BlockBatch.blocks:type_name -> zera_validator.Block
	21, // 5: zera_validator.NFT.contract_fees:type_name -> zera_txn.ItemContractFees
	16, // 6: zera_validator.Vote.vote:type_name -> zera_validator.Vote.VoteEntry
	17, // 7: zera_validator.Proposal.options:type_name -> zera_validator.Proposal.OptionsEntry
	22, // 8: zera_validator.ProposalWalletRecieve.base:type_name -> zera_txn.BaseTXN
	22, // 9: zera_validator.ProposalWalletSend.base:type_name -> zera_txn.BaseTXN
	0,  // 10: zera_validator.ValidatorService.StreamBroadcast:input_type -> zera_validator.DataChunk
	5,  // 11: zera_validator.ValidatorService.Broadcast:input_type -> zera_validator.Block
	3,  // 12: zera_validator.ValidatorService.SyncBlockchain:input_type -> zera_validator.BlockSync
	23, // 13: zera_validator.ValidatorService.ValidatorRegistration:input_type -> zera_txn.ValidatorRegistration
	1,  // 14: zera_validator.ValidatorService.SyncValidatorList:input_type -> zera_validator.ValidatorSyncRequest
	24, // 15: zera_validator.ValidatorService.ValidatorCoin:input_type -> zera_txn.CoinTXN
	25, // 16: zera_validator.ValidatorService.ValidatorMint:input_type -> zera_txn.MintTXN
	26, // 17: zera_validator.ValidatorService.ValidatorItemMint:input_type -> zera_txn.ItemizedMintTXN
	27, // 18: zera_validator.ValidatorService.ValidatorContract:input_type -> zera_txn.InstrumentContract
	28, // 19: zera_validator.ValidatorService.ValidatorGovernProposal:input_type -> zera_txn.GovernanceProposal
	29, // 20: zera_validator.ValidatorService.ValidatorGovernVote:input_type -> zera_txn.GovernanceVote
	30, // 21: zera_validator.ValidatorService.ValidatorSmartContract:input_type -> zera_txn.SmartContractTXN
	31, // 22: zera_validator.ValidatorService.ValidatorSmartContractExecute:input_type -> zera_txn.SmartContractExecuteTXN
	32, // 23: zera_validator.ValidatorService.ValidatorCurrencyEquiv:input_type -> zera_txn.SelfCurrencyEquiv
	33, // 24: zera_validator.ValidatorService.ValidatorAuthCurrencyEquiv:input_type -> zera_txn.AuthorizedCurrencyEquiv
	34, // 25: zera_validator.ValidatorService.ValidatorExpenseRatio:input_type -> zera_txn.ExpenseRatioTXN
	35, // 26: zera_validator.ValidatorService.ValidatorNFT:input_type -> zera_txn.NFTTXN
	36, // 27: zera_validator.ValidatorService.ValidatorContractUpdate:input_type -> zera_txn.ContractUpdateTXN
	37, // 28: zera_validator.ValidatorService.ValidatorHeartbeat:input_type -> zera_txn.ValidatorHeartbeat
	38, // 29: zera_validator.ValidatorService.StreamBroadcast:output_type -> google.protobuf.Empty
	38, // 30: zera_validator.ValidatorService.Broadcast:output_type -> google.protobuf.Empty
	0,  // 31: zera_validator.ValidatorService.SyncBlockchain:output_type -> zera_validator.DataChunk
	38, // 32: zera_validator.ValidatorService.ValidatorRegistration:output_type -> google.protobuf.Empty
	2,  // 33: zera_validator.ValidatorService.SyncValidatorList:output_type -> zera_validator.ValidatorSync
	38, // 34: zera_validator.ValidatorService.ValidatorCoin:output_type -> google.protobuf.Empty
	38, // 35: zera_validator.ValidatorService.ValidatorMint:output_type -> google.protobuf.Empty
	38, // 36: zera_validator.ValidatorService.ValidatorItemMint:output_type -> google.protobuf.Empty
	38, // 37: zera_validator.ValidatorService.ValidatorContract:output_type -> google.protobuf.Empty
	38, // 38: zera_validator.ValidatorService.ValidatorGovernProposal:output_type -> google.protobuf.Empty
	38, // 39: zera_validator.ValidatorService.ValidatorGovernVote:output_type -> google.protobuf.Empty
	38, // 40: zera_validator.ValidatorService.ValidatorSmartContract:output_type -> google.protobuf.Empty
	38, // 41: zera_validator.ValidatorService.ValidatorSmartContractExecute:output_type -> google.protobuf.Empty
	38, // 42: zera_validator.ValidatorService.ValidatorCurrencyEquiv:output_type -> google.protobuf.Empty
	38, // 43: zera_validator.ValidatorService.ValidatorAuthCurrencyEquiv:output_type -> google.protobuf.Empty
	38, // 44: zera_validator.ValidatorService.ValidatorExpenseRatio:output_type -> google.protobuf.Empty
	38, // 45: zera_validator.ValidatorService.ValidatorNFT:output_type -> google.protobuf.Empty
	38, // 46: zera_validator.ValidatorService.ValidatorContractUpdate:output_type -> google.protobuf.Empty
	38, // 47: zera_validator.ValidatorService.ValidatorHeartbeat:output_type -> google.protobuf.Empty
