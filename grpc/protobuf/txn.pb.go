...
type TXNStatusFees struct {
	...
	ContractFees       string     `protobuf:"bytes,5,opt,name=contract_fees,json=contractFees,proto3" json:"contract_fees,omitempty"`
	ContractContractId string     `protobuf:"bytes,6,opt,name=contract_contract_id,json=contractContractId,proto3" json:"contract_contract_id,omitempty"`
...
var file_txn_proto_rawDesc = []byte{
	...
	0x70, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x73, 0x22, 0xcf, 0x02, 0x0a, 0x09, 0x56,
