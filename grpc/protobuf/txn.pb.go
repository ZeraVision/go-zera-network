...
var file_txn_proto_rawDesc = []byte{
	...
	0x65, 0x65, 0x73, 0x22, 0x40, 0x0a, 0x05, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x12, 0x1f, 0x0a, 0x0b,
	...
	0x6e, 0x73, 0x74, 0x5f, 0x76, 0x6f, 0x74, 0x65, 0x73, 0x22, 0x89, 0x06, 0x0a, 0x0a, 0x54, 0x58,
	...
	0x79, 0x6c, 0x6f, 0x61, 0x64, 0x2a, 0x85, 0x03, 0x0a, 0x0a, 0x54, 0x58, 0x4e, 0x5f, 0x53, 0x54,
	...
	0x5f, 0x4d, 0x41, 0x58, 0x5f, 0x53, 0x55, 0x50, 0x50, 0x4c, 0x59, 0x10, 0x0d, 0x2a, 0x3f, 0x0a,
	...
	0x46, 0x54, 0x10, 0x01, 0x12, 0x07, 0x0a, 0x03, 0x53, 0x42, 0x54, 0x10, 0x02, 0x32, 0xec, 0x05,
...
var file_txn_proto_msgTypes = make([]protoimpl.MessageInfo, 28)
var file_txn_proto_goTypes = []interface{}{
	...
	(*Token)(nil),                   // 30: zera_txn.Token
	(*TokenFees)(nil),               // 31: zera_txn.TokenFees
	(*TXNStatusFees)(nil),           // 32: zera_txn.TXNStatusFees
	(*TXNWrapper)(nil),              // 33: zera_txn.TXNWrapper
...
var file_txn_proto_depIdxs = []int32{
	...
	34, // 3: zera_txn.BaseTXN.timestamp:type_name -> google.protobuf.Timestamp
	...
	32, // 41: zera_txn.TXNS.txn_fees_and_status:type_name -> zera_txn.TXNStatusFees
	31, // 42: zera_txn.TXNS.token_fees:type_name -> zera_txn.TokenFees
	30, // 43: zera_txn.TokenFees.tokens:type_name -> zera_txn.Token
	0,  // 44: zera_txn.TXNStatusFees.status:type_name -> zera_txn.TXN_STATUS
	20, // 45: zera_txn.TXNWrapper.coin_txn:type_name -> zera_txn.CoinTXN
	21, // 46: zera_txn.TXNWrapper.mint_txn:type_name -> zera_txn.MintTXN
	22, // 47: zera_txn.TXNWrapper.item_mint_txn:type_name -> zera_txn.ItemizedMintTXN
	23, // 48: zera_txn.TXNWrapper.contract_txn:type_name -> zera_txn.InstrumentContract
	24, // 49: zera_txn.TXNWrapper.governance_vote:type_name -> zera_txn.GovernanceVote
	25, // 50: zera_txn.TXNWrapper.governance_proposal:type_name -> zera_txn.GovernanceProposal
	26, // 51: zera_txn.TXNWrapper.smart_contract:type_name -> zera_txn.SmartContractTXN
	27, // 52: zera_txn.TXNWrapper.smart_contract_execute:type_name -> zera_txn.SmartContractExecuteTXN
	17, // 53: zera_txn.TXNWrapper.self_cur_equivs:type_name -> zera_txn.SelfCurrencyEquiv
	19, // 54: zera_txn.TXNWrapper.auth_cur_equivs:type_name -> zera_txn.AuthorizedCurrencyEquiv
	13, // 55: zera_txn.TXNWrapper.expense_ratios:type_name -> zera_txn.ExpenseRatioTXN
	20, // 56: zera_txn.TXNService.Coin:input_type -> zera_txn.CoinTXN
	21, // 57: zera_txn.TXNService.Mint:input_type -> zera_txn.MintTXN
	22, // 58: zera_txn.TXNService.ItemMint:input_type -> zera_txn.ItemizedMintTXN
	23, // 59: zera_txn.TXNService.Contract:input_type -> zera_txn.InstrumentContract
	25, // 60: zera_txn.TXNService.GovernProposal:input_type -> zera_txn.GovernanceProposal
	24, // 61: zera_txn.TXNService.GovernVote:input_type -> zera_txn.GovernanceVote
	26, // 62: zera_txn.TXNService.SmartContract:input_type -> zera_txn.SmartContractTXN
	27, // 63: zera_txn.TXNService.SmartContractExecute:input_type -> zera_txn.SmartContractExecuteTXN
	17, // 64: zera_txn.TXNService.CurrencyEquiv:input_type -> zera_txn.SelfCurrencyEquiv
	19, // 65: zera_txn.TXNService.AuthCurrencyEquiv:input_type -> zera_txn.AuthorizedCurrencyEquiv
	13, // 66: zera_txn.TXNService.ExpenseRatio:input_type -> zera_txn.ExpenseRatioTXN
	35, // 67: zera_txn.TXNService.Coin:output_type -> google.protobuf.Empty
	35, // 68: zera_txn.TXNService.Mint:output_type -> google.protobuf.Empty
	35, // 69: zera_txn.TXNService.ItemMint:output_type -> google.protobuf.Empty
	35, // 70: zera_txn.TXNService.Contract:output_type -> google.protobuf.Empty
	35, // 71: zera_txn.TXNService.GovernProposal:output_type -> google.protobuf.Empty
	35, // 72: zera_txn.TXNService.GovernVote:output_type -> google.protobuf.Empty
	35, // 73: zera_txn.TXNService.SmartContract:output_type -> google.protobuf.Empty
	35, // 74: zera_txn.TXNService.SmartContractExecute:output_type -> google.protobuf.Empty
	35, // 75: zera_txn.TXNService.CurrencyEquiv:output_type -> google.protobuf.Empty
	35, // 76: zera_txn.TXNService.AuthCurrencyEquiv:output_type -> google.protobuf.Empty
	35, // 77: zera_txn.TXNService.ExpenseRatio:output_type -> google.protobuf.Empty
