...
var file_validator_proto_rawDesc = []byte{
	...
	0x6c, 0x74, 0x69, 0x70, 0x6c, 0x69, 0x65, 0x72, 0x32, 0xd1, 0x11, 0x0a, 0x10, 0x56, 0x61, 0x6c,
	...
	,
...
var file_validator_proto_goTypes = []interface{}{
	...
	(*SmartContractExecuteTXN)(nil),  // 83: zera_txn.SmartContractExecuteTXN
	(*SelfCurrencyEquiv)(nil),        // 84: zera_txn.SelfCurrencyEquiv
	(*AuthorizedCurrencyEquiv)(nil),  // 85: zera_txn.AuthorizedCurrencyEquiv
	(*ExpenseRatioTXN)(nil),          // 86: zera_txn.ExpenseRatioTXN
	(*NFTTXN)(nil),                   // 87: zera_txn.NFTTXN
	(*ContractUpdateTXN)(nil),        // 88: zera_txn.ContractUpdateTXN
	(*ValidatorHeartbeat)(nil),       // 89: zera_txn.ValidatorHeartbeat
	(*FoundationTXN)(nil),            // 90: zera_txn.FoundationTXN
	(*DelegatedVotingTXN)(nil),       // 91: zera_txn.DelegatedVotingTXN
	(*QuashTXN)(nil),                 // 92: zera_txn.QuashTXN
	(*FastQuorumTXN)(nil),            // 93: zera_txn.FastQuorumTXN
	(*RevokeTXN)(nil),                // 94: zera_txn.RevokeTXN
	(*ComplianceTXN)(nil),            // 95: zera_txn.ComplianceTXN
	(*BurnSBTTXN)(nil),               // 96: zera_txn.BurnSBTTXN
	(*CoinTXN)(nil),                  // 97: zera_txn.CoinTXN
...
var file_validator_proto_depIdxs = []int32{
	...
	83, // 79: zera_validator.ValidatorService.ValidatorSmartContractExecute:input_type -> zera_txn.SmartContractExecuteTXN
	84, // 80: zera_validator.ValidatorService.ValidatorCurrencyEquiv:input_type -> zera_txn.SelfCurrencyEquiv
	85, // 81: zera_validator.ValidatorService.ValidatorAuthCurrencyEquiv:input_type -> zera_txn.AuthorizedCurrencyEquiv
	86, // 82: zera_validator.ValidatorService.ValidatorExpenseRatio:input_type -> zera_txn.ExpenseRatioTXN
	87, // 83: zera_validator.ValidatorService.ValidatorNFT:input_type -> zera_txn.NFTTXN
	88, // 84: zera_validator.ValidatorService.ValidatorContractUpdate:input_type -> zera_txn.ContractUpdateTXN
	89, // 85: zera_validator.ValidatorService.ValidatorHeartbeat:input_type -> zera_txn.ValidatorHeartbeat
	90, // 86: zera_validator.ValidatorService.ValidatorFoundation:input_type -> zera_txn.FoundationTXN
	91, // 87: zera_validator.ValidatorService.ValidatorDelegatedVoting:input_type -> zera_txn.DelegatedVotingTXN
	29, // 88: zera_validator.ValidatorService.IndexerVoting:input_type -> zera_validator.IndexerVotingRequest
	92, // 89: zera_validator.ValidatorService.ValidatorQuash:input_type -> zera_txn.QuashTXN
	93, // 90: zera_validator.ValidatorService.ValidatorFastQuorum:input_type -> zera_txn.FastQuorumTXN
	94, // 91: zera_validator.ValidatorService.ValidatorRevoke:input_type -> zera_txn.RevokeTXN
	95, // 92: zera_validator.ValidatorService.ValidatorCompliance:input_type -> zera_txn.ComplianceTXN
	96, // 93: zera_validator.ValidatorService.ValidatorBurnSBT:input_type -> zera_txn.BurnSBTTXN
	8,  // 94: zera_validator.ValidatorService.Nonce:input_type -> zera_validator.NonceRequest
	97, // 95: zera_validator.ValidatorService.ValidatorCoin:input_type -> zera_txn.CoinTXN
	10, // 96: zera_validator.ValidatorService.StreamBlockAttestation:input_type -> zera_validator.DataChunk
	98, // 97: zera_validator.ValidatorService.StreamFailedBlock:output_type -> google.protobuf.Empty
	98, // 98: zera_validator.ValidatorService.StreamBroadcast:output_type -> google.protobuf.Empty
	10, // 99: zera_validator.ValidatorService.SyncBlockchain:output_type -> zera_validator.DataChunk
	98, // 100: zera_validator.ValidatorService.Broadcast:output_type -> google.protobuf.Empty
	98, // 101: zera_validator.ValidatorService.ValidatorRegistration:output_type -> google.protobuf.Empty
	12, // 102: zera_validator.ValidatorService.SyncValidatorList:output_type -> zera_validator.ValidatorSync
	98, // 103: zera_validator.ValidatorService.ValidatorMint:output_type -> google.protobuf.Empty
	98, // 104: zera_validator.ValidatorService.ValidatorItemMint:output_type -> google.protobuf.Empty
	98, // 105: zera_validator.ValidatorService.ValidatorContract:output_type -> google.protobuf.Empty
	98, // 106: zera_validator.ValidatorService.ValidatorGovernProposal:output_type -> google.protobuf.Empty
	98, // 107: zera_validator.ValidatorService.ValidatorGovernVote:output_type -> google.protobuf.Empty
	98, // 108: zera_validator.ValidatorService.ValidatorSmartContract:output_type -> google.protobuf.Empty
	98, // 109: zera_validator.ValidatorService.ValidatorSmartContractExecute:output_type -> google.protobuf.Empty
	98, // 110: zera_validator.ValidatorService.ValidatorCurrencyEquiv:output_type -> google.protobuf.Empty
	98, // 111: zera_validator.ValidatorService.ValidatorAuthCurrencyEquiv:output_type -> google.protobuf.Empty
	98, // 112: zera_validator.ValidatorService.ValidatorExpenseRatio:output_type -> google.protobuf.Empty
	98, // 113: zera_validator.ValidatorService.ValidatorNFT:output_type -> google.protobuf.Empty
	98, // 114: zera_validator.ValidatorService.ValidatorContractUpdate:output_type -> google.protobuf.Empty
	98, // 115: zera_validator.ValidatorService.ValidatorHeartbeat:output_type -> google.protobuf.Empty
	98, // 116: zera_validator.ValidatorService.ValidatorFoundation:output_type -> google.protobuf.Empty
	98, // 117: zera_validator.ValidatorService.ValidatorDelegatedVoting:output_type -> google.protobuf.Empty
	32, // 118: zera_validator.ValidatorService.IndexerVoting:output_type -> zera_validator.IndexerVotingResponse
	98, // 119: zera_validator.ValidatorService.ValidatorQuash:output_type -> google.protobuf.Empty
	98, // 120: zera_validator.ValidatorService.ValidatorFastQuorum:output_type -> google.protobuf.Empty
	98, // 121: zera_validator.ValidatorService.ValidatorRevoke:output_type -> google.protobuf.Empty
	98, // 122: zera_validator.ValidatorService.ValidatorCompliance:output_type -> google.protobuf.Empty
	98, // 123: zera_validator.ValidatorService.ValidatorBurnSBT:output_type -> google.protobuf.Empty
	9,  // 124: zera_validator.ValidatorService.Nonce:output_type -> zera_validator.NonceResponse
	98, // 125: zera_validator.ValidatorService.ValidatorCoin:output_type -> google.protobuf.Empty
	10, // 126: zera_validator.ValidatorService.StreamBlockAttestation:output_type -> zera_validator.DataChunk
