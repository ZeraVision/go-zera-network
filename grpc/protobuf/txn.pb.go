...
type Governance struct {
	...
	FastQuorum                *uint32          `protobuf:"varint,3,opt,name=fast_quorum,json=fastQuorum,proto3,oneof" json:"fast_quorum,omitempty"`            // % of yes votes to instantly pass (% is based off max supply)
	...
	ChickenDinner             *bool            `protobuf:"varint,6,opt,name=chicken_dinner,json=chickenDinner,proto3,oneof" json:"chicken_dinner,omitempty"`   // winner not over threshold
	...
	ProposalPeriod            *PROPOSAL_PERIOD `protobuf:"varint,10,opt,name=proposal_period,json=proposalPeriod,proto3,enum=zera_txn.PROPOSAL_PERIOD,oneof" json:"proposal_period,omitempty"` // Is the total_period in months or days? months will start then cycle on the 1st of a month, days will start it on any day.
...
var file_txn_proto_rawDesc = []byte{
	...
	0x22, 0xa5, 0x05, 0x0a, 0x0a, 0x47, 0x6f, 0x76, 0x65, 0x72, 0x6e, 0x61, 0x6e, 0x63, 0x65, 0x12,
	...
	,
	...
	0x42, 0x09, 0x0a, 0x07, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x2a, 0xad, 0x04, 0x0a, 0x0a,
	...
	0x54, 0x45, 0x10, 0x13, 0x12, 0x15, 0x0a, 0x11, 0x52, 0x45, 0x53, 0x54, 0x52, 0x49, 0x43, 0x54,
	0x45, 0x44, 0x5f, 0x53, 0x59, 0x4d, 0x42, 0x4f, 0x4c, 0x10, 0x14, 0x2a, 0xa7, 0x03, 0x0a, 0x10,
	...
	0x59, 0x50, 0x45, 0x10, 0x10, 0x2a, 0x3f, 0x0a, 0x08, 0x4c, 0x41, 0x4e, 0x47, 0x55, 0x41, 0x47,
	...
	0x54, 0x10, 0x01, 0x12, 0x07, 0x0a, 0x03, 0x53, 0x42, 0x54, 0x10, 0x02, 0x32, 0xec, 0x07, 0x0a,
...
var file_txn_proto_depIdxs = []int32{
	...
	8,   // 103: zera_txn.TXNService.DelegatedVoting:input_type -> zera_txn.DelegatedVotingTXN
	50,  // 104: zera_txn.TXNService.Coin:output_type -> google.protobuf.Empty
	50,  // 105: zera_txn.TXNService.Mint:output_type -> google.protobuf.Empty
	50,  // 106: zera_txn.TXNService.ItemMint:output_type -> google.protobuf.Empty
	50,  // 107: zera_txn.TXNService.Contract:output_type -> google.protobuf.Empty
	50,  // 108: zera_txn.TXNService.GovernProposal:output_type -> google.protobuf.Empty
	50,  // 109: zera_txn.TXNService.GovernVote:output_type -> google.protobuf.Empty
	50,  // 110: zera_txn.TXNService.SmartContract:output_type -> google.protobuf.Empty
	50,  // 111: zera_txn.TXNService.SmartContractExecute:output_type -> google.protobuf.Empty
	50,  // 112: zera_txn.TXNService.CurrencyEquiv:output_type -> google.protobuf.Empty
	50,  // 113: zera_txn.TXNService.AuthCurrencyEquiv:output_type -> google.protobuf.Empty
	50,  // 114: zera_txn.TXNService.ExpenseRatio:output_type -> google.protobuf.Empty
	50,  // 115: zera_txn.TXNService.NFT:output_type -> google.protobuf.Empty
	50,  // 116: zera_txn.TXNService.ContractUpdate:output_type -> google.protobuf.Empty
	50,  // 117: zera_txn.TXNService.Foundation:output_type -> google.protobuf.Empty
	50,  // 118: zera_txn.TXNService.DelegatedVoting:output_type -> google.protobuf.Empty
