...
const (
	...
	TRANSACTION_TYPE_NEW_COIN_TYPE                  TRANSACTION_TYPE = 23
	TRANSACTION_TYPE_UKNOWN_TYPE                    TRANSACTION_TYPE = 24
)
...
func (x *Compliance) GetExpiry() *timestamppb.Timestamp {
	if x != nil {
		return x.Expiry
	}
	return nil
...
type Governance struct {
	...
	RegularQuorum             uint32                 `protobuf:"varint,2,opt,name=regular_quorum,json=regularQuorum,proto3" json:"regular_quorum,omitempty"`         //percent of yes votes to pass at the end of cycle (still needs to pass threshhold) 100 = 100&
	FastQuorum                *uint32                `protobuf:"varint,3,opt,name=fast_quorum,json=fastQuorum,proto3,oneof" json:"fast_quorum,omitempty"`            //Percent of yes votes to instantly pass (% based off circulating supply) 100 = 100%
	...
	Threshold                 uint32                 `protobuf:"varint,5,opt,name=threshold,proto3" json:"threshold,omitempty"`                                      //threshold of participation of holders needed to be accepted 1000 = 1000%
...
type PublicKey struct {
	...
	GovernanceAuth *GovernanceAuth `protobuf:"bytes,4,opt,name=governance_auth,json=governanceAuth,proto3,oneof" json:"governance_auth,omitempty"`
}
...
func (x *PublicKey) GetGovernanceAuth() *GovernanceAuth {
	if x != nil {
...
type MultiKey struct {
	...
	MultiPatterns []*MultiPatterns `protobuf:"bytes,3,rep,name=multi_patterns,json=multiPatterns,proto3" json:"multi_patterns,omitempty"`
	HashTokens    []string         `protobuf:"bytes,4,rep,name=hash_tokens,json=hashTokens,proto3" json:"hash_tokens,omitempty"`
}
...
type MultiPatterns struct {
	...
	Class    []int32 `protobuf:"varint,1,rep,packed,name=class,proto3" json:"class,omitempty"`
...
type ComplianceAssign struct {
	...
	ComplianceLevel  uint32 `protobuf:"varint,2,opt,name=compliance_level,json=complianceLevel,proto3" json:"compliance_level,omitempty"`
	AssignRevoke     bool   `protobuf:"varint,3,opt,name=assign_revoke,json=assignRevoke,proto3" json:"assign_revoke,omitempty"`
}
...
func (x *NewCoinTXN) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*NewCoinTXN) ProtoMessage() {}

func (x *NewCoinTXN) ProtoReflect() protoreflect.Message {
	mi := &file_txn_proto_msgTypes[37]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use NewCoinTXN.ProtoReflect.Descriptor instead.
func (*NewCoinTXN) Descriptor() ([]byte, []int) {
	return file_txn_proto_rawDescGZIP(), []int{37}
}

func (x *NewCoinTXN) GetBase() *BaseTXN {
	if x != nil {
		return x.Base
	}
	return nil
...
func (x *NewCoinTXN) GetContractId() string {
	if x != nil {
		return x.ContractId
	}
	return ""
...
func (x *NewCoinTXN) GetAuth() *TransferAuthentication {
	if x != nil {
		return x.Auth
	}
	return nil
...
func (x *NewCoinTXN) GetInputTransfers() []*InputTransfers {
	if x != nil {
...
func (x *NewCoinTXN) GetOutputTransfers() []*OutputTransfers {
	if x != nil {
...
type InputTransfers struct {
	...
	Amount            string  `protobuf:"bytes,2,opt,name=amount,proto3" json:"amount,omitempty"`
	BaseFeeAmount     string  `protobuf:"bytes,3,opt,name=base_fee_amount,json=baseFeeAmount,proto3" json:"base_fee_amount,omitempty"`
	BaseFeeId         string  `protobuf:"bytes,4,opt,name=base_fee_id,json=baseFeeId,proto3" json:"base_fee_id,omitempty"`
	FeePercent        uint32  `protobuf:"varint,5,opt,name=fee_percent,json=feePercent,proto3" json:"fee_percent,omitempty"` // 100 000 000 = 100%
	ContractFeeAmount *string `protobuf:"bytes,6,opt,name=contract_fee_amount,json=contractFeeAmount,proto3,oneof" json:"contract_fee_amount,omitempty"`
	ContractFeeId     *string `protobuf:"bytes,7,opt,name=contract_fee_id,json=contractFeeId,proto3,oneof" json:"contract_fee_id,omitempty"`
}
...
func (x *InputTransfers) GetBaseFeeAmount() string {
	if x != nil {
		return x.BaseFeeAmount
	}
	return ""
...
func (x *InputTransfers) GetBaseFeeId() string {
	if x != nil {
		return x.BaseFeeId
	}
	return ""
...
func (x *InputTransfers) GetContractFeeAmount() string {
	if x != nil && x.ContractFeeAmount != nil {
		return *x.ContractFeeAmount
	}
	return ""
...
func (x *InputTransfers) GetContractFeeId() string {
	if x != nil && x.ContractFeeId != nil {
		return *x.ContractFeeId
	}
	return ""
...
type GovernanceProposal struct {
	...
	GovernanceTxn  *GovernanceTXN         `protobuf:"bytes,9,opt,name=governance_txn,json=governanceTxn,proto3,oneof" json:"governance_txn,omitempty"`
}
...
type Validator struct {
	...
	ValidatorPort string                 `protobuf:"bytes,5,opt,name=validator_port,json=validatorPort,proto3" json:"validator_port,omitempty"`
...
type TXNS struct {
	...
	NewCoinTxns               []*NewCoinTXN              `protobuf:"bytes,28,rep,name=new_coin_txns,json=newCoinTxns,proto3" json:"new_coin_txns,omitempty"`
}
...
func (x *TXNS) GetNewCoinTxns() []*NewCoinTXN {
	if x != nil {
		return x.NewCoinTxns
	}
	return nil
}
...
type TXNStatusFees struct {
	...
	SmarContractResult [][]byte   `protobuf:"bytes,10,rep,name=smar_contract_result,json=smarContractResult,proto3" json:"smar_contract_result,omitempty"`
	ApprovedVotes      *string    `protobuf:"bytes,7,opt,name=approved_votes,json=approvedVotes,proto3,oneof" json:"approved_votes,omitempty"` //TODO - REMOVE THIS?
	AgainstVotes       *string    `protobuf:"bytes,8,opt,name=against_votes,json=againstVotes,proto3,oneof" json:"against_votes,omitempty"`    //TODO - REMOVE THIS?
...
func (x *TXNStatusFees) GetSmarContractResult() [][]byte {
	if x != nil {
		return x.SmarContractResult
	}
	return nil
}
...
type TXNWrapper struct {
	...
	//	*TXNWrapper_NewCoinTxn
	Payload isTXNWrapper_Payload `protobuf_oneof:"payload"`
	TxnType TRANSACTION_TYPE     `protobuf:"varint,25,opt,name=txn_type,json=txnType,proto3,enum=zera_txn.TRANSACTION_TYPE" json:"txn_type,omitempty"`
}
...
func (x *TXNWrapper) GetNewCoinTxn() *NewCoinTXN {
	if x, ok := x.GetPayload().(*TXNWrapper_NewCoinTxn); ok {
		return x.NewCoinTxn
	}
	return nil
}
...
type TXNWrapper_NewCoinTxn struct {
	NewCoinTxn *NewCoinTXN `protobuf:"bytes,24,opt,name=new_coin_txn,json=newCoinTxn,proto3,oneof"`
}
...
func (*TXNWrapper_NewCoinTxn) isTXNWrapper_Payload() {}
...
var file_txn_proto_rawDesc = []byte{
	...
	0x6f, 0x75, 0x6e, 0x74, 0x22, 0x8c, 0x01, 0x0a, 0x0a, 0x43, 0x6f, 0x6d, 0x70, 0x6c, 0x69, 0x61,
	0x6e, 0x63, 0x65, 0x12, 0x1f, 0x0a, 0x0b, 0x63, 0x6f, 0x6e, 0x74, 0x72, 0x61, 0x63, 0x74, 0x5f,
	0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x63, 0x6f, 0x6e, 0x74, 0x72, 0x61,
	0x63, 0x74, 0x49, 0x64, 0x12, 0x29, 0x0a, 0x10, 0x63, 0x6f, 0x6d, 0x70, 0x6c, 0
 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1c,
	...
	0x5f, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x5f, 0x74, 0x78, 0x6e, 0x73, 0x18, 0x12, 0x20, 0x03,
	...
	0x6f, 0x5f, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x5f, 0x74, 0x78, 0x6e, 0x73, 0x18, 0x13, 0x20,
	...
	,
	...
	0x09, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x46, 0x65, 0x65, 0x73, 0x12, 0x18, 0x0a, 0x07, 0x61, 0x64,
	0x64, 0x72, 0x65, 0x73, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x07, 0x61, 0x64, 0x64,
	0x72, 0x65, 0x73, 0x73, 0x12, 0x27, 0x0a, 0x06, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x73, 0x18, 0x02,
	0x20, 0x03, 0x28, 0x0b, 0x32, 0x0f, 0x2e, 0x7a, 0x65, 0x72, 0x61, 0x5f, 0x74, 0x78, 0x6e, 0x2e,
	0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x52, 0x06, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x73, 0x22, 0xca, 0x03,
	...
	0x5f, 0x66, 0x65, 0x65, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x09, 0x52, 0x08, 0x62, 0x61, 0x73,
	0x65, 0x46, 0x65, 0x65, 0x73, 0x12, 0x28, 0x0a, 0x10, 0x62, 0x61, 0x73, 0x65, 0x5f, 0x63, 0x6f,
	0x6e, 0x74, 0x72, 0x61, 0x63, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x04, 0x20, 0x03, 0x28, 0x09, 0x52,
	...
	,
	...
	,
	...
	,
	...
	0x02, 0x32, 0xc8, 0x0a, 0x0a, 0x0a, 0x54, 0x58, 0x4e, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	...
	,
	...
	0x0a, 0x08, 0x43, 0x6f, 0x6e, 0x74, 0x72, 0x61, 0x63, 0x74, 0x12, 0x1c, 0x2e, 0x7a, 0x65, 0x72,
	...
	,
	...
	,
	...
	0x6f, 0x62, 0x75, 0x66, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x12, 0x45, 0x0a, 0x0e, 0x43, 0x6f,
	...
	,
...
var file_txn_proto_msgTypes = make([]protoimpl.MessageInfo, 63)
var file_txn_proto_goTypes = []interface{}{
	...
	(*NewCoinTXN)(nil),              // 45: zera_txn.NewCoinTXN
	(*TransferAuthentication)(nil),  // 46: zera_txn.TransferAuthentication
	(*InputTransfers)(nil),          // 47: zera_txn.InputTransfers
	(*OutputTransfers)(nil),         // 48: zera_txn.OutputTransfers
	(*MintTXN)(nil),                 // 49: zera_txn.MintTXN
	(*NFTTXN)(nil),                  // 50: zera_txn.NFTTXN
	(*ItemizedMintTXN)(nil),         // 51: zera_txn.ItemizedMintTXN
	(*ContractUpdateTXN)(nil),       // 52: zera_txn.ContractUpdateTXN
	(*InstrumentContract)(nil),      // 53: zera_txn.InstrumentContract
	...
	(*ProposalResult)(nil),          // 65: zera_txn.ProposalResult
	(*TXNS)(nil),                    // 66: zera_txn.TXNS
	(*Token)(nil),                   // 67: zera_txn.Token
	(*TokenFees)(nil),               // 68: zera_txn.TokenFees
	(*TXNStatusFees)(nil),           // 69: zera_txn.TXNStatusFees
	(*TXNWrapper)(nil),              // 70: zera_txn.TXNWrapper
...
var file_txn_proto_depIdxs = []int32{
	...
	71,  // 4: zera_txn.Compliance.expiry:type_name -> google.protobuf.Timestamp
	12,  // 5: zera_txn.TokenCompliance.compliance:type_name -> zera_txn.Compliance
	1,   // 6: zera_txn.ByteMultiplier.txn_type:type_name -> zera_txn.TRANSACTION_TYPE
	30,  // 7: zera_txn.FoundationTXN.base:type_name -> zera_txn.BaseTXN
	16,  // 8: zera_txn.FoundationTXN.byte_multiplier:type_name -> zera_txn.ByteMultiplier
	30,  // 9: zera_txn.RevokeTXN.base:type_name -> zera_txn.BaseTXN
	30,  // 10: zera_txn.FastQuorumTXN.base:type_name -> zera_txn.BaseTXN
	6,   // 11: zera_txn.Governance.type:type_name -> zera_txn.GOVERNANCE_TYPE
	3,   // 12: zera_txn.Governance.proposal_period:type_name -> zera_txn.PROPOSAL_PERIOD
	21,  // 13: zera_txn.Governance.stage_length:type_name -> zera_txn.Stage
	71,  // 14: zera_txn.Governance.start_timestamp:type_name -> google.protobuf.Timestamp
	3,   // 15: zera_txn.Stage.period:type_name -> zera_txn.PROPOSAL_PERIOD
	5,   // 16: zera_txn.ContractFees.contract_fee_type:type_name -> zera_txn.CONTRACT_FEE_TYPE
	31,  // 17: zera_txn.RestrictedKey.public_key:type_name -> zera_txn.PublicKey
	30,  // 18: zera_txn.ExpenseRatioTXN.base:type_name -> zera_txn.BaseTXN
	30,  // 19: zera_txn.BurnSBTTXN.base:type_name -> zera_txn.BaseTXN
	31,  // 20: zera_txn.BaseTXN.public_key:type_name -> zera_txn.PublicKey
	71,  // 21: zera_txn.BaseTXN.timestamp:type_name -> google.protobuf.Timestamp
	33,  // 22: zera_txn.PublicKey.multi:type_name -> zera_txn.MultiKey
	32,  // 23: zera_txn.PublicKey.governance_auth:type_name -> zera_txn.GovernanceAuth
	34,  // 24: zera_txn.MultiKey.multi_patterns:type_name -> zera_txn.MultiPatterns
	30,  // 25: zera_txn.SelfCurrencyEquiv.base:type_name -> zera_txn.BaseTXN
	37,  // 26: zera_txn.SelfCurrencyEquiv.cur_equiv:type_name -> zera_txn.CurrencyEquiv
	30,  // 27: zera_txn.AuthorizedCurrencyEquiv.base:type_name -> zera_txn.BaseTXN
	37,  // 28: zera_txn.AuthorizedCurrencyEquiv.cur_equiv:type_name -> zera_txn.CurrencyEquiv
	41,  // 29: zera_txn.ExpenseRatioResult.wallets:type_name -> zera_txn.Wallets
	30,  // 30: zera_txn.ComplianceTXN.base:type_name -> zera_txn.BaseTXN
	39,  // 31: zera_txn.ComplianceTXN.compliance:type_name -> zera_txn.ComplianceAssign
	30,  // 32: zera_txn.QuashTXN.base:type_name -> zera_txn.BaseTXN
	31,  // 33: zera_txn.QuashResult.public_keys:type_name -> zera_txn.PublicKey
	30,  // 34: zera_txn.CoinTXN.base:type_name -> zera_txn.BaseTXN
	28,  // 35: zera_txn.CoinTXN.transfers:type_name -> zera_txn.Transfer
	30,  // 36: zera_txn.NewCoinTXN.base:type_name -> zera_txn.BaseTXN
	46,  // 37: zera_txn.NewCoinTXN.auth:type_name -> zera_txn.TransferAuthentication
	47,  // 38: zera_txn.NewCoinTXN.input_transfers:type_name -> zera_txn.InputTransfers
	48,  // 39: zera_txn.NewCoinTXN.output_transfers:type_name -> zera_txn.OutputTransfers
	31,  // 40: zera_txn.TransferAuthentication.public_key:type_name -> zera_txn.PublicKey
	30,  // 41: zera_txn.MintTXN.base:type_name -> zera_txn.BaseTXN
	30,  // 42: zera_txn.NFTTXN.base:type_name -> zera_txn.BaseTXN
	30,  // 43: zera_txn.ItemizedMintTXN.base:type_name -> zera_txn.BaseTXN
	15,  // 44: zera_txn.ItemizedMintTXN.parameters:type_name -> zera_txn.KeyValuePair
	24,  // 45: zera_txn.ItemizedMintTXN.contract_fees:type_name -> zera_txn.ItemContractFees
	30,  // 46: zera_txn.ContractUpdateTXN.base:type_name -> zera_txn.BaseTXN
	20,  // 47: zera_txn.ContractUpdateTXN.governance:type_name -> zera_txn.Governance
	25,  // 48: zera_txn.ContractUpdateTXN.restricted_keys:type_name -> zera_txn.RestrictedKey
	23,  // 49: zera_txn.ContractUpdateTXN.contract_fees:type_name -> zera_txn.ContractFees
	15,  // 50: zera_txn.ContractUpdateTXN.custom_parameters:type_name -> zera_txn.KeyValuePair
	14,  // 51: zera_txn.ContractUpdateTXN.expense_ratio:type_name -> zera_txn.ExpenseRatio
	30,  // 52: zera_txn.InstrumentContract.base:type_name -> zera_txn.BaseTXN
	20,  // 53: zera_txn.InstrumentContract.governance:type_name -> zera_txn.Governance
	25,  // 54: zera_txn.InstrumentContract.restricted_keys:type_name -> zera_txn.RestrictedKey
	23,  // 55: zera_txn.InstrumentContract.contract_fees:type_name -> zera_txn.ContractFees
	27,  // 56: zera_txn.InstrumentContract.premint_wallets:type_name -> zera_txn.PreMintWallet
	22,  // 57: zera_txn.InstrumentContract.coin_denomination:type_name -> zera_txn.CoinDenomination
	15,  // 58: zera_txn.InstrumentContract.custom_parameters:type_name -> zera_txn.KeyValuePair
	14,  // 59: zera_txn.InstrumentContract.expense_ratio:type_name -> zera_txn.ExpenseRatio
	7,   // 60: zera_txn.InstrumentContract.type:type_name -> zera_txn.CONTRACT_TYPE
	13,  // 61: zera_txn.InstrumentContract.token_compliance:type_name -> zera_txn.TokenCompliance
	...
	71,  // 64: zera_txn.GovernanceProposal.start_timestamp:type_name -> google.protobuf.Timestamp
	71,  // 65: zera_txn.GovernanceProposal.end_timestamp:type_name -> google.protobuf.Timestamp
	...
	62,  // 70: zera_txn.SmartContractTXN.variable_type:type_name -> zera_txn.SmartContractParameter
	30,  // 71: zera_txn.SmartContractExecuteTXN.base:type_name -> zera_txn.BaseTXN
	62,  // 72: zera_txn.SmartContractExecuteTXN.parameters:type_name -> zera_txn.SmartContractParameter
	31,  // 73: zera_txn.Validator.public_key:type_name -> zera_txn.PublicKey
	71,  // 74: zera_txn.Validator.timestamp:type_name -> google.protobuf.Timestamp
	30,  // 75: zera_txn.ValidatorRegistration.base:type_name -> zera_txn.BaseTXN
	59,  // 76: zera_txn.ValidatorRegistration.validator:type_name -> zera_txn.Validator
	...
	64,  // 79: zera_txn.Votes.votes:type_name -> zera_txn.VotePair
	...
	44,  // 84: zera_txn.TXNS.coin_txns:type_name -> zera_txn.CoinTXN
	49,  // 85: zera_txn.TXNS.mint_txns:type_name -> zera_txn.MintTXN
	51,  // 86: zera_txn.TXNS.item_mint_txns:type_name -> zera_txn.ItemizedMintTXN
	53,  // 87: zera_txn.TXNS.contract_txns:type_name -> zera_txn.InstrumentContract
	54,  // 88: zera_txn.TXNS.governance_votes:type_name -> zera_txn.GovernanceVote
	55,  // 89: zera_txn.TXNS.governance_proposals:type_name -> zera_txn.GovernanceProposal
	57,  // 90: zera_txn.TXNS.smart_contracts:type_name -> zera_txn.SmartContractTXN
	58,  // 91: zera_txn.TXNS.smart_contract_executes:type_name -> zera_txn.SmartContractExecuteTXN
	35,  // 92: zera_txn.TXNS.self_cur_equivs:type_name -> zera_txn.SelfCurrencyEquiv
	36,  // 93: zera_txn.TXNS.auth_cur_equivs:type_name -> zera_txn.AuthorizedCurrencyEquiv
	26,  // 94: zera_txn.TXNS.expense_ratios:type_name -> zera_txn.ExpenseRatioTXN
	69,  // 95: zera_txn.TXNS.txn_fees_and_status:type_name -> zera_txn.TXNStatusFees
	68,  // 96: zera_txn.TXNS.token_fees:type_name -> zera_txn.TokenFees
	50,  // 97: zera_txn.TXNS.nft_txns:type_name -> zera_txn.NFTTXN
	52,  // 98: zera_txn.TXNS.contract_update_txns:type_name -> zera_txn.ContractUpdateTXN
	...
	65,  // 101: zera_txn.TXNS.proposal_result_txns:type_name -> zera_txn.ProposalResult
	38,  // 102: zera_txn.TXNS.expense_ratio_result_txns:type_name -> zera_txn.ExpenseRatioResult
	17,  // 103: zera_txn.TXNS.foundation_txns:type_name -> zera_txn.FoundationTXN
	9,   // 104: zera_txn.TXNS.delegated_voting_txns:type_name -> zera_txn.DelegatedVotingTXN
	42,  // 105: zera_txn.TXNS.quash_txns:type_name -> zera_txn.QuashTXN
	19,  // 106: zera_txn.TXNS.fast_quorum_txns:type_name -> zera_txn.FastQuorumTXN
	43,  // 107: zera_txn.TXNS.quash_results:type_name -> zera_txn.QuashResult
	18,  // 108: zera_txn.TXNS.revoke_txns:type_name -> zera_txn.RevokeTXN
	40,  // 109: zera_txn.TXNS.compliance_txns:type_name -> zera_txn.ComplianceTXN
	29,  // 110: zera_txn.TXNS.burn_sbt_txns:type_name -> zera_txn.BurnSBTTXN
	45,  // 111: zera_txn.TXNS.new_coin_txns:type_name -> zera_txn.NewCoinTXN
	67,  // 112: zera_txn.TokenFees.tokens:type_name -> zera_txn.Token
	...
	49,  // 115: zera_txn.TXNWrapper.mint_txn:type_name -> zera_txn.MintTXN
	51,  // 116: zera_txn.TXNWrapper.item_mint_txn:type_name -> zera_txn.ItemizedMintTXN
	53,  // 117: zera_txn.TXNWrapper.contract_txn:type_name -> zera_txn.InstrumentContract
	54,  // 118: zera_txn.TXNWrapper.governance_vote:type_name -> zera_txn.GovernanceVote
	55,  // 119: zera_txn.TXNWrapper.governance_proposal:type_name -> zera_txn.GovernanceProposal
	57,  // 120: zera_txn.TXNWrapper.smart_contract:type_name -> zera_txn.SmartContractTXN
	58,  // 121: zera_txn.TXNWrapper.smart_contract_execute:type_name -> zera_txn.SmartContractExecuteTXN
	...
	50,  // 125: zera_txn.TXNWrapper.nft_txn:type_name -> zera_txn.NFTTXN
	52,  // 126: zera_txn.TXNWrapper.contract_update_txn:type_name -> zera_txn.ContractUpdateTXN
	...
	45,  // 136: zera_txn.TXNWrapper.new_coin_txn:type_name -> zera_txn.NewCoinTXN
	1,   // 137: zera_txn.TXNWrapper.txn_type:type_name -> zera_txn.TRANSACTION_TYPE
	44,  // 138: zera_txn.TXNService.Coin:input_type -> zera_txn.CoinTXN
	45,  // 139: zera_txn.TXNService.NewCoin:input_type -> zera_txn.NewCoinTXN
	49,  // 140: zera_txn.TXNService.Mint:input_type -> zera_txn.MintTXN
	51,  // 141: zera_txn.TXNService.ItemMint:input_type -> zera_txn.ItemizedMintTXN
	53,  // 142: zera_txn.TXNService.Contract:input_type -> zera_txn.InstrumentContract
	55,  // 143: zera_txn.TXNService.GovernProposal:input_type -> zera_txn.GovernanceProposal
	54,  // 144: zera_txn.TXNService.GovernVote:input_type -> zera_txn.GovernanceVote
	57,  // 145: zera_txn.TXNService.SmartContract:input_type -> zera_txn.SmartContractTXN
	58,  // 146: zera_txn.TXNService.SmartContractExecute:input_type -> zera_txn.SmartContractExecuteTXN
	35,  // 147: zera_txn.TXNService.CurrencyEquiv:input_type -> zera_txn.SelfCurrencyEquiv
	36,  // 148: zera_txn.TXNService.AuthCurrencyEquiv:input_type -> zera_txn.AuthorizedCurrencyEquiv
	26,  // 149: zera_txn.TXNService.ExpenseRatio:input_type -> zera_txn.ExpenseRatioTXN
	50,  // 150: zera_txn.TXNService.NFT:input_type -> zera_txn.NFTTXN
	52,  // 151: zera_txn.TXNService.ContractUpdate:input_type -> zera_txn.ContractUpdateTXN
	17,  // 152: zera_txn.TXNService.Foundation:input_type -> zera_txn.FoundationTXN
	9,   // 153: zera_txn.TXNService.DelegatedVoting:input_type -> zera_txn.DelegatedVotingTXN
	42,  // 154: zera_txn.TXNService.Quash:input_type -> zera_txn.QuashTXN
	19,  // 155: zera_txn.TXNService.FastQuorum:input_type -> zera_txn.FastQuorumTXN
	18,  // 156: zera_txn.TXNService.Revoke:input_type -> zera_txn.RevokeTXN
	40,  // 157: zera_txn.TXNService.Compliance:input_type -> zera_txn.ComplianceTXN
	29,  // 158: zera_txn.TXNService.BurnSBT:input_type -> zera_txn.BurnSBTTXN
	72,  // 159: zera_txn.TXNService.Coin:output_type -> google.protobuf.Empty
	72,  // 160: zera_txn.TXNService.NewCoin:output_type -> google.protobuf.Empty
	72,  // 161: zera_txn.TXNService.Mint:output_type -> google.protobuf.Empty
	72,  // 162: zera_txn.TXNService.ItemMint:output_type -> google.protobuf.Empty
	72,  // 163: zera_txn.TXNService.Contract:output_type -> google.protobuf.Empty
	72,  // 164: zera_txn.TXNService.GovernProposal:output_type -> google.protobuf.Empty
	72,  // 165: zera_txn.TXNService.GovernVote:output_type -> google.protobuf.Empty
	72,  // 166: zera_txn.TXNService.SmartContract:output_type -> google.protobuf.Empty
	72,  // 167: zera_txn.TXNService.SmartContractExecute:output_type -> google.protobuf.Empty
	72,  // 168: zera_txn.TXNService.CurrencyEquiv:output_type -> google.protobuf.Empty
	72,  // 169: zera_txn.TXNService.AuthCurrencyEquiv:output_type -> google.protobuf.Empty
	72,  // 170: zera_txn.TXNService.ExpenseRatio:output_type -> google.protobuf.Empty
	72,  // 171: zera_txn.TXNService.NFT:output_type -> google.protobuf.Empty
	72,  // 172: zera_txn.TXNService.ContractUpdate:output_type -> google.protobuf.Empty
	72,  // 173: zera_txn.TXNService.Foundation:output_type -> google.protobuf.Empty
	72,  // 174: zera_txn.TXNService.DelegatedVoting:output_type -> google.protobuf.Empty
	72,  // 175: zera_txn.TXNService.Quash:output_type -> google.protobuf.Empty
	72,  // 176: zera_txn.TXNService.FastQuorum:output_type -> google.protobuf.Empty
	72,  // 177: zera_txn.TXNService.Revoke:output_type -> google.protobuf.Empty
	72,  // 178: zera_txn.TXNService.Compliance:output_type -> google.protobuf.Empty
	72,  // 179: zera_txn.TXNService.BurnSBT:output_type -> google.protobuf.Empty
