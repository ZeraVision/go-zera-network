...
type APIServiceClient interface {
	...
	ACETokens(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ACETokensResponse, error)
...
func (c *aPIServiceClient) ACETokens(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ACETokensResponse, error) {
...
type APIServiceServer interface {
	...
	ACETokens(context.Context, *emptypb.Empty) (*ACETokensResponse, error)
...
func (UnimplementedAPIServiceServer) ACETokens(context.Context, *emptypb.Empty) (*ACETokensResponse, error) {
...
func _APIService_ACETokens_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(APIServiceServer).ACETokens(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
