...
var file_validator_proto_rawDesc = []byte{
	...
	0x73, 0x32, 0xed, 0x0b, 0x0a, 0x10, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x6f, 0x72, 0x53,
...
var file_validator_proto_goTypes = []interface{}{
	...
	nil,                             // 19: zera_validator.Vote.VoteEntry
	nil,                             // 20: zera_validator.VoteWallet.ProposalVotesEntry
	nil,                             // 21: zera_validator.Proposal.YesEntry
	nil,                             // 22: zera_validator.Proposal.NoEntry
	nil,                             // 23: zera_validator.Proposal.OptionsEntry
	(*Validator)(nil),               // 24: zera_txn.Validator
	(*timestamppb.Timestamp)(nil),   // 25: google.protobuf.Timestamp
	(*TXNS)(nil),                    // 26: zera_txn.TXNS
	(*ItemContractFees)(nil),        // 27: zera_txn.ItemContractFees
	(*BaseTXN)(nil),                 // 28: zera_txn.BaseTXN
	(*ValidatorRegistration)(nil),   // 29: zera_txn.ValidatorRegistration
	(*CoinTXN)(nil),                 // 30: zera_txn.CoinTXN
	(*MintTXN)(nil),                 // 31: zera_txn.MintTXN
	(*ItemizedMintTXN)(nil),         // 32: zera_txn.ItemizedMintTXN
	(*InstrumentContract)(nil),      // 33: zera_txn.InstrumentContract
	(*GovernanceProposal)(nil),      // 34: zera_txn.GovernanceProposal
	(*GovernanceVote)(nil),          // 35: zera_txn.GovernanceVote
	(*SmartContractTXN)(nil),        // 36: zera_txn.SmartContractTXN
	(*SmartContractExecuteTXN)(nil), // 37: zera_txn.SmartContractExecuteTXN
	(*SelfCurrencyEquiv)(nil),       // 38: zera_txn.SelfCurrencyEquiv
	(*AuthorizedCurrencyEquiv)(nil), // 39: zera_txn.AuthorizedCurrencyEquiv
	(*ExpenseRatioTXN)(nil),         // 40: zera_txn.ExpenseRatioTXN
	(*NFTTXN)(nil),                  // 41: zera_txn.NFTTXN
	(*ContractUpdateTXN)(nil),       // 42: zera_txn.ContractUpdateTXN
	(*ValidatorHeartbeat)(nil),      // 43: zera_txn.ValidatorHeartbeat
	(*FoundationTXN)(nil),           // 44: zera_txn.FoundationTXN
	(*emptypb.Empty)(nil),           // 45: google.protobuf.Empty
}
var file_validator_proto_depIdxs = []int32{
	24, // 0: zera_validator.ValidatorSync.validators:type_name -> zera_txn.Validator
	25, // 1: zera_validator.BlockHeader.timestamp:type_name -> google.protobuf.Timestamp
	4,  // 2: zera_validator.Block.block_header:type_name -> zera_validator.BlockHeader
	26, // 3: zera_validator.Block.transactions:type_name -> zera_txn.TXNS
	5,  // 4: zera_validator.BlockBatch.blocks:type_name -> zera_validator.Block
	27, // 5: zera_validator.NFT.contract_fees:type_name -> zera_txn.ItemContractFees
	19, // 6: zera_validator.Vote.vote:type_name -> zera_validator.Vote.VoteEntry
	20, // 7: zera_validator.VoteWallet.proposal_votes:type_name -> zera_validator.VoteWallet.ProposalVotesEntry
	21, // 8: zera_validator.Proposal.yes:type_name -> zera_validator.Proposal.YesEntry
	22, // 9: zera_validator.Proposal.no:type_name -> zera_validator.Proposal.NoEntry
	23, // 10: zera_validator.Proposal.options:type_name -> zera_validator.Proposal.OptionsEntry
	11, // 11: zera_validator.Proposal.voters:type_name -> zera_validator.Voter
	28, // 12: zera_validator.ProposalWalletRecieve.base:type_name -> zera_txn.BaseTXN
	28, // 13: zera_validator.ProposalWalletSend.base:type_name -> zera_txn.BaseTXN
	11, // 14: zera_validator.VoteWallet.ProposalVotesEntry.value:type_name -> zera_validator.Voter
	10, // 15: zera_validator.Proposal.OptionsEntry.value:type_name -> zera_validator.Vote
	0,  // 16: zera_validator.ValidatorService.StreamBroadcast:input_type -> zera_validator.DataChunk
	5,  // 17: zera_validator.ValidatorService.Broadcast:input_type -> zera_validator.Block
	3,  // 18: zera_validator.ValidatorService.SyncBlockchain:input_type -> zera_validator.BlockSync
	29, // 19: zera_validator.ValidatorService.ValidatorRegistration:input_type -> zera_txn.ValidatorRegistration
	1,  // 20: zera_validator.ValidatorService.SyncValidatorList:input_type -> zera_validator.ValidatorSyncRequest
	30, // 21: zera_validator.ValidatorService.ValidatorCoin:input_type -> zera_txn.CoinTXN
	31, // 22: zera_validator.ValidatorService.ValidatorMint:input_type -> zera_txn.MintTXN
	32, // 23: zera_validator.ValidatorService.ValidatorItemMint:input_type -> zera_txn.ItemizedMintTXN
	33, // 24: zera_validator.ValidatorService.ValidatorContract:input_type -> zera_txn.InstrumentContract
	34, // 25: zera_validator.ValidatorService.ValidatorGovernProposal:input_type -> zera_txn.GovernanceProposal
	35, // 26: zera_validator.ValidatorService.ValidatorGovernVote:input_type -> zera_txn.GovernanceVote
	36, // 27: zera_validator.ValidatorService.ValidatorSmartContract:input_type -> zera_txn.SmartContractTXN
	37, // 28: zera_validator.ValidatorService.ValidatorSmartContractExecute:input_type -> zera_txn.SmartContractExecuteTXN
	38, // 29: zera_validator.ValidatorService.ValidatorCurrencyEquiv:input_type -> zera_txn.SelfCurrencyEquiv
	39, // 30: zera_validator.ValidatorService.ValidatorAuthCurrencyEquiv:input_type -> zera_txn.AuthorizedCurrencyEquiv
	40, // 31: zera_validator.ValidatorService.ValidatorExpenseRatio:input_type -> zera_txn.ExpenseRatioTXN
	41, // 32: zera_validator.ValidatorService.ValidatorNFT:input_type -> zera_txn.NFTTXN
	42, // 33: zera_validator.ValidatorService.ValidatorContractUpdate:input_type -> zera_txn.ContractUpdateTXN
	43, // 34: zera_validator.ValidatorService.ValidatorHeartbeat:input_type -> zera_txn.ValidatorHeartbeat
	44, // 35: zera_validator.ValidatorService.ValidatorFoundation:input_type -> zera_txn.FoundationTXN
	45, // 36: zera_validator.ValidatorService.StreamBroadcast:output_type -> google.protobuf.Empty
	45, // 37: zera_validator.ValidatorService.Broadcast:output_type -> google.protobuf.Empty
	0,  // 38: zera_validator.ValidatorService.SyncBlockchain:output_type -> zera_validator.DataChunk
	45, // 39: zera_validator.ValidatorService.ValidatorRegistration:output_type -> google.protobuf.Empty
	2,  // 40: zera_validator.ValidatorService.SyncValidatorList:output_type -> zera_validator.ValidatorSync
	45, // 41: zera_validator.ValidatorService.ValidatorCoin:output_type -> google.protobuf.Empty
	45, // 42: zera_validator.ValidatorService.ValidatorMint:output_type -> google.protobuf.Empty
	45, // 43: zera_validator.ValidatorService.ValidatorItemMint:output_type -> google.protobuf.Empty
	45, // 44: zera_validator.ValidatorService.ValidatorContract:output_type -> google.protobuf.Empty
	45, // 45: zera_validator.ValidatorService.ValidatorGovernProposal:output_type -> google.protobuf.Empty
	45, // 46: zera_validator.ValidatorService.ValidatorGovernVote:output_type -> google.protobuf.Empty
	45, // 47: zera_validator.ValidatorService.ValidatorSmartContract:output_type -> google.protobuf.Empty
	45, // 48: zera_validator.ValidatorService.ValidatorSmartContractExecute:output_type -> google.protobuf.Empty
	45, // 49: zera_validator.ValidatorService.ValidatorCurrencyEquiv:output_type -> google.protobuf.Empty
	45, // 50: zera_validator.ValidatorService.ValidatorAuthCurrencyEquiv:output_type -> google.protobuf.Empty
	45, // 51: zera_validator.ValidatorService.ValidatorExpenseRatio:output_type -> google.protobuf.Empty
	45, // 52: zera_validator.ValidatorService.ValidatorNFT:output_type -> google.protobuf.Empty
	45, // 53: zera_validator.ValidatorService.ValidatorContractUpdate:output_type -> google.protobuf.Empty
	45, // 54: zera_validator.ValidatorService.ValidatorHeartbeat:output_type -> google.protobuf.Empty
	45, // 55: zera_validator.ValidatorService.ValidatorFoundation:output_type -> google.protobuf.Empty
