...
var file_validator_proto_rawDesc = []byte{
	...
	0x75, 0x6e, 0x74, 0x73, 0x32, 0xa5, 0x0b, 0x0a, 0x10, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74,
	0x6f, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x46, 0x0a, 0x0f, 0x53, 0x74, 0x72,
	...
	0x43, 0x68, 0x75, 0x6e, 0x6b, 0x30, 0x01, 0x12, 0x50, 0x0a, 0x15, 0x56, 0x61, 0x6c, 0x69, 0x64,
	0x61, 0x74, 0x6f, 0x72, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	0x12, 0x1f, 0x2e, 0x7a, 0x65, 0x72, 0x61, 0x5f, 0x74, 0x78, 0x6e, 0x2e, 0x56, 0x61, 0x6c, 0x69,
	...
	0x62, 0x75, 0x66, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x12, 0x58, 0x0a, 0x11, 0x53, 0x79, 0x6e,
	0x63, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x6f, 0x72, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x24,
	0x2e, 0x7a, 0x65, 0x72, 0x61, 0x5f, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x6f, 0x72, 0x2e,
	0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x6f, 0x72, 0x53, 0x79, 0x6e, 0x63, 0x52, 0x65, 0x71,
	...
	0x79, 0x6e, 0x63, 0x12, 0x3a, 0x0a, 0x0d, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x6f, 0x72,
...
var file_validator_proto_goTypes = []interface{}{
	...
	nil,                             // 14: zera_validator.Vote.VoteEntry
	nil,                             // 15: zera_validator.Proposal.OptionsEntry
	...
	(*ValidatorRegistration)(nil),   // 21: zera_txn.ValidatorRegistration
	...
	(*GovernanceProposal)(nil),      // 26: zera_txn.GovernanceProposal
	...
	(*SelfCurrencyEquiv)(nil),       // 30: zera_txn.SelfCurrencyEquiv
	(*AuthorizedCurrencyEquiv)(nil), // 31: zera_txn.AuthorizedCurrencyEquiv
	(*ExpenseRatioTXN)(nil),         // 32: zera_txn.ExpenseRatioTXN
...
var file_validator_proto_depIdxs = []int32{
	...
	14, // 6: zera_validator.Vote.vote:type_name -> zera_validator.Vote.VoteEntry
	15, // 7: zera_validator.Proposal.options:type_name -> zera_validator.Proposal.OptionsEntry
	20, // 8: zera_validator.ProposalWalletRecieve.base:type_name -> zera_txn.BaseTXN
	20, // 9: zera_validator.ProposalWalletSend.base:type_name -> zera_txn.BaseTXN
	...
	21, // 13: zera_validator.ValidatorService.ValidatorRegistration:input_type -> zera_txn.ValidatorRegistration
	1,  // 14: zera_validator.ValidatorService.SyncValidatorList:input_type -> zera_validator.ValidatorSyncRequest
	22, // 15: zera_validator.ValidatorService.ValidatorCoin:input_type -> zera_txn.CoinTXN
	23, // 16: zera_validator.ValidatorService.ValidatorMint:input_type -> zera_txn.MintTXN
	24, // 17: zera_validator.ValidatorService.ValidatorItemMint:input_type -> zera_txn.ItemizedMintTXN
	25, // 18: zera_validator.ValidatorService.ValidatorContract:input_type -> zera_txn.InstrumentContract
	26, // 19: zera_validator.ValidatorService.ValidatorGovernProposal:input_type -> zera_txn.GovernanceProposal
	27, // 20: zera_validator.ValidatorService.ValidatorGovernVote:input_type -> zera_txn.GovernanceVote
	28, // 21: zera_validator.ValidatorService.ValidatorSmartContract:input_type -> zera_txn.SmartContractTXN
	29, // 22: zera_validator.ValidatorService.ValidatorSmartContractExecute:input_type -> zera_txn.SmartContractExecuteTXN
	30, // 23: zera_validator.ValidatorService.ValidatorCurrencyEquiv:input_type -> zera_txn.SelfCurrencyEquiv
	31, // 24: zera_validator.ValidatorService.ValidatorAuthCurrencyEquiv:input_type -> zera_txn.AuthorizedCurrencyEquiv
	32, // 25: zera_validator.ValidatorService.ValidatorExpenseRatio:input_type -> zera_txn.ExpenseRatioTXN
	33, // 26: zera_validator.ValidatorService.ValidatorNFT:input_type -> zera_txn.NFTTXN
	34, // 27: zera_validator.ValidatorService.ValidatorContractUpdate:input_type -> zera_txn.ContractUpdateTXN
	35, // 28: zera_validator.ValidatorService.ValidatorHeartbeat:input_type -> zera_txn.ValidatorHeartbeat
	36, // 29: zera_validator.ValidatorService.StreamBroadcast:output_type -> google.protobuf.Empty
	36, // 30: zera_validator.ValidatorService.Broadcast:output_type -> google.protobuf.Empty
	0,  // 31: zera_validator.ValidatorService.SyncBlockchain:output_type -> zera_validator.DataChunk
	36, // 32: zera_validator.ValidatorService.ValidatorRegistration:output_type -> google.protobuf.Empty
	2,  // 33: zera_validator.ValidatorService.SyncValidatorList:output_type -> zera_validator.ValidatorSync
	36, // 34: zera_validator.ValidatorService.ValidatorCoin:output_type -> google.protobuf.Empty
	36, // 35: zera_validator.ValidatorService.ValidatorMint:output_type -> google.protobuf.Empty
	36, // 36: zera_validator.ValidatorService.ValidatorItemMint:output_type -> google.protobuf.Empty
	36, // 37: zera_validator.ValidatorService.ValidatorContract:output_type -> google.protobuf.Empty
	36, // 38: zera_validator.ValidatorService.ValidatorGovernProposal:output_type -> google.protobuf.Empty
	36, // 39: zera_validator.ValidatorService.ValidatorGovernVote:output_type -> google.protobuf.Empty
	36, // 40: zera_validator.ValidatorService.ValidatorSmartContract:output_type -> google.protobuf.Empty
	36, // 41: zera_validator.ValidatorService.ValidatorSmartContractExecute:output_type -> google.protobuf.Empty
	36, // 42: zera_validator.ValidatorService.ValidatorCurrencyEquiv:output_type -> google.protobuf.Empty
	36, // 43: zera_validator.ValidatorService.ValidatorAuthCurrencyEquiv:output_type -> google.protobuf.Empty
	36, // 44: zera_validator.ValidatorService.ValidatorExpenseRatio:output_type -> google.protobuf.Empty
	36, // 45: zera_validator.ValidatorService.ValidatorNFT:output_type -> google.protobuf.Empty
	36, // 46: zera_validator.ValidatorService.ValidatorContractUpdate:output_type -> google.protobuf.Empty
	36, // 47: zera_validator.ValidatorService.ValidatorHeartbeat:output_type -> google.protobuf.Empty
