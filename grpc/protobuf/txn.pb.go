...
type DelegatedFees struct {
	...
	Address   []byte       `protobuf:"bytes,1,opt,name=address,proto3" json:"address,omitempty"`
	TokenFees []*TokenFees `protobuf:"bytes,2,rep,name=token_fees,json=tokenFees,proto3" json:"token_fees,omitempty"`
}
...
var file_txn_proto_rawDesc = []byte{
	...
	0x66, 0x65, 0x65, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x13, 0x2e, 0x7a, 0x65, 0x72,
